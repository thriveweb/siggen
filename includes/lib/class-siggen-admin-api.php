...
class SigGen_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
            ...
            case 'info':
                $html .= '<div id="'.esc_attr($field['id']).'">'.$field['html'].'</div>'."\n";
                break;
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'siggen' ) . '" data-uploader_button_text="' . __( 'Use image', 'siggen' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'siggen' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'siggen' ) . '" />' . "\n";
			...
			case 'color':
				//phpcs:disable
				?>
                <div class="form-field <?php echo $field['class']; ?>">
                    <label for="<?php echo $field['id']; ?>"><?php echo $field['label']; ?></label>
                    <div class="color-picker" style="position:relative;">
                        <input type="text" name="<?php esc_attr_e($option_name); ?>" class="color" value="<?php echo ($data ? esc_attr_e($data) : '#000000'); ?>" />
	...
	public function display_meta_box_field( $field = array(), $post = null ) {
        ...
        if ($field['type'] === 'color') {
            ...
            $field = '<p class="form-field '.$field['class'].'"><label for="' . $field['id'] . '">' . $field['label'] . '</label>' . $this->display_field( $field, $post, false ) . '</p>' . "\n";
        }
